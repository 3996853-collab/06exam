  ...
  <div class="abnormal-detail-page">
    ...
    <el-card class="header-card" shadow="never">
      <el-page-header @back="goBack">
        <template #content>
          <span class="header-title">异常数据明细 - {{ activeMetricMeta?.name }}</span>
        </template>
        <template #extra>
          <div class="header-actions">
            <el-button type="primary" :icon="Download" @click="handleExport" size="default">
              导出 Excel
            </el-button>
          </div>
        </template>
